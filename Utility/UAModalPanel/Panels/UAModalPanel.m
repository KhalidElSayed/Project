...
- (CGRect)actionButtonFrame {
    if (![[self.actionButton titleForState:UIControlStateNormal] length]) return CGRectZero;
...
- (void)show {
    if ([delegate respondsToSelector:@selector(willShowModalPanel:)]) [delegate willShowModalPanel:self];
                                              ...
                                              completion:^(BOOL finished) {
                                                  ...
                                                  [UIView animateWithDuration:0.1
                                                                   ...
                                                                   completion:^(BOOL finished) {
                                                                       ...
                                                                       if ([delegate respondsToSelector:@selector(didShowModalPanel:)]) [delegate didShowModalPanel:self];
                                                                   }];
                                              }];
                         }];
    };
...
- (void)hide {
    ...
    if ([delegate respondsToSelector:@selector(willCloseModalPanel:)]) [delegate willCloseModalPanel:self];
